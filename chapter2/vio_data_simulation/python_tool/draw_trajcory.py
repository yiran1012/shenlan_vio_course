...
with open(filepath + '/euler/imu_pose.txt', 'r') as f:  # imu_circle   imu_spline
...
quaterntions1 = []
timestamp1 = []
with open(filepath + '/euler/imu_int_pose.txt', 'r') as f:  # imu_pose   imu_spline
...
quaterntions2 = []
timestamp2 = []
with open(filepath + '/midpoint/imu_int_pose.txt', 'r') as f:  # cam_pose_opt_o_0   cam_pose_opt_o_0
...
ax.plot(xyz1[0], xyz1[1], xyz1[2], label='imu_euler_int')
ax.plot(xyz2[0], xyz2[1], xyz2[2], label='imu_midpoint_int')
ax.legend()
